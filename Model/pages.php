...
class pages extends \Model\Database
{
    ...
    {
        return [
            "idPa" => $this->idPa, "idGroup" => $this->idGroup, "idGroupName" => $this->idGroup()->Name, "Name" => $this->Name, "Alias" => $this->Alias, "isShow" => $this->isShow, "Type" => $this->Type, "OrderBy" => $this->OrderBy, "TypeName" => $this->Type()
        ];
    }
    ...
    function TimPages4TieuDeKD($alias, $isobj = true)
    {
        return parent::PagesByAlias($alias, $isobj);
    }
