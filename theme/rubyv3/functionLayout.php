...
class functionLayout
{
                        ...
                        <div class="recent-work-item">
                            <div class="item-content">
                                <em>
                                    ...
                                    <a href="<?php echo $_v->UrlHinh() ?>" class="fancybox-button" title="<?php echo $_v->Name ?>"
            ...
            <div class="col-md-12">
                ...
                <div class="owl-carousel owl-carousel4">
                    <div class="recent-work-item">
                        <div class="item-content">
                            <em>
                                <img src="/public/bdsltp/public/images/banner/nha1.jpg" alt="Amazing Project"
                                    class="img-responsive">
                                <a href="portfolio-item.html"><i class="fa fa-link"></i></a>
                                <a href="/public/images/banner/nha1.jpg" class="fancybox-button" title="Project Name #1"
                                    data-rel="fancybox-button"><i class="fa fa-search"></i></a>
                            </em>
                            <a class="recent-work-description" href="javascript:;">
                                            ...
                                            <div class="col-md-3 col-xs-6 col-sm-4 mix category_1 mix_all" style="opacity: 1; ">
                                                <div class="mix-inner ">
                                                    <a href="<?php echo $_v->linkNewsCurent(); ?>">
                                                        <img style="width: 100%;" alt="<?php echo $_v->Name ?>"
                                                            data-src="<?php echo $_v->UrlHinh() ?>" src="/public/loading.svg"
                                                            class="lazy HinhChuNhat img-responsive">
                                                    </a>
                        ...
                        foreach ($news as $k => $value) {
                            ...
                            <div class="item">
                                <div class="khachangnoigi-content">
                                    <div class="col-md-4">
                                        <img class="img img-responsive img-circle" style="border-radius: 100px;"
                                            src="<?php echo $_v->UrlHinh(); ?>" alt="">
                                        <div class="">
    ...
    static function head()
    {
        ...
        <link rel="stylesheet" type="text/css"
            href="/public/rubyv3/style.css?v=<?php echo filemtime("public/rubyv3/style.css") ?>" />
        <link href="/public/Phonering/phonering.css?v=<?php echo filemtime('public/Phonering/phonering.css'); ?>"
            rel="stylesheet" type="text/css" />
        <script
            src="/public/partials/loaderpartials/home/homeconfig.js?v=<?php echo fileatime("public/partials/loaderpartials/home/homeconfig.js"); ?>"></script>
        <link href="/public/wowjs/animate.min.css<?php echo filemtime("public/wowjs/animate.min.css"); ?>" rel="stylesheet"
            type="text/css" />
            ...
            <div class="main-header">
                <div class="container ">
                    <div class="row">
                            ...
                            <form action="/index/seach/" class="form-inline">
                                <div class="form-search">
                                    <div class="form-group input-serach">
                                        <input value="<?php echo $_REQUEST["seach"] ?? ""; ?>" name="seach" type="text"
                        ...
                        <div class="col-xs-12 hidden-sm hidden-xs col-md-6 Supper-Title text-center">
                            <h2 class="hotline"><i class="fa fa-phone"></i> <a href="tel:__Hotline___">__Hotline___</a> </h2>
                            <h2 class="email"><i class="fa fa-envelope"></i> <a href="maito:__Email___">__Email___</a> </h2>
                        </div>
                    </div>
                </div>
            </div>
...
HTML;
    ...
    static function footer()
    {
        ...
        <div style="position: fixed;right: 150px;bottom: 330px;z-index: 99999"
            class="hidden-xs phonering-alo-phone phonering-alo-green phonering-alo-show" id="phonering-alo-phoneIcon">
        ...
        <div style="position: fixed;right: 150px;bottom: 230px;z-index: 99999"
            class="hidden-xs phonering-alo-phone phonering-alo-green phonering-alo-show" id="phonering-alo-phoneIcon">
            <div class="phonering-alo-ph-circle"></div>
            <div class="phonering-alo-ph-circle-fill"></div>
        ...
        <div style="position: fixed;right: 150px;bottom: 430px;z-index: 99999"
            class="hidden-xs phonering-alo-phone phonering-alo-green phonering-alo-show" id="phonering-zalo-phoneIcon1">
            <div class="phonering-alo-ph-circle"></div>
            <div class="phonering-alo-ph-circle-fill"></div>
    ...
    static function js()
    {
        ...
        ?>
        <script type='text/javascript'
            src='https://platform-api.sharethis.com/js/sharethis.js#property=611f2ae4f4d23f00121c6e0b&product=sop'
            async='async'></script>
        <?php
    }
                ...
                <div class="header-navigation font-transform-inherit">
                    <ul class="">
                        <li ng-repeat="item in _MenuTopMainMenu" ng-class="item.submenu ? 'dropdown' : ''" class="">
                            <a ng-href="{{item.submenu?'#':item.Link}}"
                                data-toggle="{{item.submenu?'dropdown':''}}">{{item.Name}}
                ...
                <form action="/timkiem/index/" method="GET">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                            value="<?php echo isset($_GET["keyword"]) ? $_GET["keyword"] : ""; ?>" name="keyword"
                    ...
                    <div ng-repeat="news in _baivietmoinhat" class="row margin-bottom-10">
                        <div class="col-md-3">
                            <a href="{{news.Link}}" class=" " style="display: block;">
                                <img onerror="this.src='/public/lawkimsa/Images/h1.jpg'" class="img-responsive"
                                    alt="{{news.Name}}" src="{{news.UrlHinh}}">
                            </a>
                        </div>
                        <div class="col-md-9 recent-news-inner">
                            <h3><a style="color: #000;font-weight: bold;font-size: 1em;" href="{{news.Link}}">{{news.Name}}</a>
                            </h3>
