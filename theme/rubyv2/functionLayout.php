...
?>
    ...
    {
    ?>
        <div class="pre-header" style="margin-top: 0px;padding-top: 10px;">
            <div class="container">
                <div class="row">
                    <div style="margin-top: 0px;" class="col-md-6 col-sm-6">
                        <ul class="list-unstyled list-inline">
                            <li>
                                <a style="color: #fff;" href="tel:__Hotline___"><i class="fa fa-phone"></i>__Hotline___ </a>
                            </li>
                            <li>
                                <a style="color: #fff;" href="mailTo:__Email___"><i class="fa fa-envelope-o"></i>__Email___ </a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-6 col-sm-6 dsnhanvien additional-nav">
                        <ng-nhan-vien></ng-nhan-vien>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="header">
            <div class="container">
                ...
                <div class="col-md-8">
                    <div class="d-flex" style="margin-top: 10px;margin-bottom: 10px;" ng-init="CSKHInit()" ng-controller="nhanvienController">
                        <form action="/timkiem/index/" style="margin-top: 10px;margin: auto;">
                            <div class="input-group">
                                <input style="width: 200px;" name="keyword" type="text" placeholder="Tìm kiếm ấn phẩm" class="form-control">
                                <span class="input-group-btn">
                                    <button style="background-color: #777;height:35px;width: 60px;border-radius: 0px !important;" class="btn btn-primary" type="submit">
        ...
        <div class="header" style="background-color: #fff;">
            <div class="container">
                ...
                <div class="header-navigation font-transform-inherit">
                    <ul>
                        <li class="logo_reduce-header" style="padding: 0px;margin: 0px;">
                            <a style="padding: 0px;margin: 0px;" class="site-logo" href="/">
                                <img style="border-radius: 10px !important;padding: 0px;margin: 0px;margin-top: 3px;" src="__Logo___" alt="__WebName___">
                            </a>
                        </li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <ng-address pre-text="Địa chỉ xưởng:" address="__DiaChiXuong___"></ng-address>
                            </div>
                            <div class="col-md-6">
                                <ng-address pre-text="Địa chỉ:" address="__DiaChi___"></ng-address>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div style="border-top: 1px solid #999; padding-top: 10px;"></div>
                        <ng-tags></ng-tags>
                    </div>
        ...
        <div class="product-container">
            <div class="left-block">
                <a class="linkproductcat" href="<?php echo $produc->linkProduct(); ?>">
                    <img on-error-src="/public/images_load.gif" class=" img-responsive" alt="<?php echo $produc->Name ?>" src="<?php echo $produc->UrlHinh(); ?>" />
                </a>
                <?php
                if ($produc->Price > 0) {
                ?>
